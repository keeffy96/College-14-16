...
$sql = "INSERT INTO Quiz2(answerOne,answerTwo,answerThree,answerFour,answerFive,answerSix,answerSeven,answerEight,answerNine,answerTen) VALUES ('$_POST[answerOne]','$_POST[answerTwo]','$_POST[answerThree]','$_POST[answerFour]','$_POST[answerFive]','$_POST[answerSix]','$_POST[answerSeven]','$_POST[answerEight]','$_POST[answerNine]','$_POST[answerTen]')";
...
<form action="ShowEntry2.php" method="post">
     <br>
